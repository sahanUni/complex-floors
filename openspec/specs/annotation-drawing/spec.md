...
Defines the requirements for drawing, storing, and loading rectangular bounding box annotations on PDF pages, including the SVG overlay interaction model, PDF-space coordinate conversion, and backend persistence endpoints.
