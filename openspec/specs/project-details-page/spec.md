...
Defines the requirements for the dedicated Project Details page at `/projects/[id]`, which displays a project's uploaded documents and all confirmed extracted SVG regions, and allows the user to open the PDF viewer for annotation and extraction.
